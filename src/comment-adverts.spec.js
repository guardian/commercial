...
import fakeMediator from '@guardian/frontend/static/src/javascripts/lib/mediator';
...
import { isUserLoggedIn as isUserLoggedIn_ } from '@guardian/frontend/static/src/javascripts/projects/common/modules/identity/api';
	...
	it('should insert a DMPU slot if there is enough space', (done) => {
		...
		initCommentAdverts().then(() => {
			...
			fakeMediator.once('page:commercial:comments', () => {
				const adSlot = document.querySelector('.js-ad-slot');
