...
import { pbTestNameMap } from '@guardian/frontend/static/src/javascripts/lib/url';
import {
	isInAuOrNz,
	isInRow,
	isInUk,
	isInUsOrCa,
} from '@guardian/frontend/static/src/javascripts/projects/common/modules/commercial/geo-utils';
...
export const containsMpu = (sizes) => contains(sizes, [300, 250]);

export const containsDmpu = (sizes) => contains(sizes, [300, 600]);

export const containsLeaderboard = (sizes) => contains(sizes, [728, 90]);

export const containsBillboard = (sizes) => contains(sizes, [970, 250]);

export const containsMpuOrDmpu = (sizes) =>
	containsMpu(sizes) || containsDmpu(sizes);

export const containsMobileSticky = (sizes) => contains(sizes, [320, 50]);

export const containsLeaderboardOrBillboard = (sizes) =>
...
export const containsWS = (sizes) => contains(sizes, [160, 600]);
