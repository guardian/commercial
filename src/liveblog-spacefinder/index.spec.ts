import { calculateLiveblogBlockSize, shouldDisplayAd } from './index';

describe('calculateLiveblogBlockSize', () => {
	...
	describe('zero elements', () => {
		it('should return zero when there are zero elements', () => {
			expect(calculateLiveblogBlockSize([])).toEqual(0);
		});
	});

	describe('text block elements', () => {
		it('should return the correct height for varying line length', () => {
			expect(calculateLiveblogBlockSize(textElementOneLine)).toEqual(52);
			expect(calculateLiveblogBlockSize(textElementTwoLines)).toEqual(79);
		});

		it('should return the correct height when there are multiple elements', () => {
			expect(calculateLiveblogBlockSize(multipleTextElements)).toEqual(
				104,
			);
		});
	});
	...
	describe('youtube block elements', () => {
		it('should return the correct height', () => {
			expect(calculateLiveblogBlockSize(youtubeElement)).toEqual(375);
		});
	});
});
